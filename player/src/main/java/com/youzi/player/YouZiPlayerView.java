 ...
 * 描述:
 */
public class YouZiPlayerView extends FrameLayout {
    ...
    public YouZiPlayerView(@NonNull Context context) {
        this(context, null);
    }

    public YouZiPlayerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YouZiPlayerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
