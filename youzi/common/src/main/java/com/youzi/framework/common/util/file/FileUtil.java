package com.youzi.framework.common.util.file;

import android.graphics.Bitmap;
import android.support.annotation.NonNull;

import com.youzi.framework.common.util.utils.CacheUtil;
import com.youzi.framework.common.util.utils.StringUtil;
...
public class FileUtil {
    ...
    public static File writeToFile(Bitmap bitmap, File dest) throws IOException {
        boolean isSuccess = bitmap.compress(Bitmap.CompressFormat.PNG, 100, new FileOutputStream(dest));
        return isSuccess ? dest : null;
    }
     ...
     * @throws IOException
     */
    public static File writeFile(@NonNull final InputStream src, File dest, boolean closeSrc) throws IOException {
