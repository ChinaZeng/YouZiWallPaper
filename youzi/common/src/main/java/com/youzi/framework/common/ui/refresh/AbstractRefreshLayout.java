...
abstract class AbstractRefreshLayout extends FrameLayout implements IRefreshLayout {
    ...
    public void refreshFailed() {
        getIRefreshLayout().refreshFailed();
    }

    @Override
    public void loadMoreFailed() {
        getIRefreshLayout().loadMoreFailed();
    }

    @Override
    public boolean isRefreshEnable() {
        return getIRefreshLayout().isRefreshEnable();
    }

    @Override
    public boolean isLoadMoreEnable() {
        return getIRefreshLayout().isLoadMoreEnable();
    }
}
