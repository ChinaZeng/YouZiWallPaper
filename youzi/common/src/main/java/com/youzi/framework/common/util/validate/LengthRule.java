...
public class LengthRule extends ValidateRule {
    ...
    public LengthRule(TextView textView,boolean trim, int minLength, int maxLength, int flag) {
        super(textView,trim);
        this.maxLength = maxLength;
        this.minLength = minLength;
        this.flag = flag;
    ...
    public static LengthRule eq(String value,int len){
        return new LengthRule(value,len,len, LengthRule.FLAG_INCLUSIVE_INCLUSIVE);
    }

    public static LengthRule eq(TextView textView,boolean trim,int len){
        return new LengthRule(textView,trim,len,len, LengthRule.FLAG_INCLUSIVE_INCLUSIVE);
    }
    ...
    public static LengthRule lt(TextView textView, boolean trim, int maxValue) {
        return new LengthRule(textView,trim, Integer.MIN_VALUE, maxValue, LengthRule.FLAG_INCLUSIVE_INCLUSIVE);
    }
    ...
    public static LengthRule lt(TextView textView, boolean trim, int maxValue, int flag) {
        return new LengthRule(textView,trim, Integer.MIN_VALUE, maxValue, flag);
    }
    ...
    public static LengthRule gt(TextView textView, boolean trim, int minValue) {
        return new LengthRule(textView,trim, minValue, Integer.MAX_VALUE, LengthRule.FLAG_INCLUSIVE_INCLUSIVE);
    }
    ...
    public static LengthRule gt(TextView textView, boolean trim, int minValue, int flag) {
        return new LengthRule(textView,trim, minValue, Integer.MAX_VALUE, flag);
    }
    ...
    public static LengthRule range(TextView textView, boolean trim, int minValue, int maxValue) {
        return new LengthRule(textView,trim, minValue, maxValue, LengthRule.FLAG_INCLUSIVE_INCLUSIVE);
    }
    ...
    public static LengthRule range(TextView textView, boolean trim, int minValue, int maxValue, int flag) {
        return new LengthRule(textView,trim, minValue, maxValue, flag);
    }

    @Override
    public Boolean apply(Boolean aBoolean) throws Exception {
        String text = getTextByView(value);
